...
function EventDetails() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        fetch(` https://au-temps-donne-api.onrender.com/api/event/activites/update/${eventId}`, {
            method: 'PUT',
            headers: {
    ...
    function deleteEvent(eventId) {
        fetch(` https://au-temps-donne-api.onrender.com/api/event/activites/delete/${eventId}`, {
            method: 'DELETE'
        })
        .then(response => {
            if (response.ok) {
                                       ...
                                       <div className="header">
                                        ...
                                        <div className="list-container">
                                            <div className="list-card">
                                                <h4>Bénévoles</h4>
                                                <Link id="voir" to={`/admin/volunteers/${eventId}`} className="btn-link">Voir la liste</Link>
                                            ...
                                            <div className="list-card">
                                                <h4>Bénéficiaires</h4>
                                                <Link id="voir" to={`/admin/beneficiaires/${eventId}`} className="btn-link">Voir la liste</Link>
                                                <div className="download-button">
                                                <button  id="download" className="btn-link" onClick={handleDownloadBenefPDF}>Télécharger</button>
                                            </div>
                                            </div>
                                        </div>
                                    </div>
